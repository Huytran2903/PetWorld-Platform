...
CREATE TABLE dbo.PetHealthPhotos (
                                     ...
                                     CreatedAt DATETIME2 NOT NULL DEFAULT SYSDATETIME(),
                                     CONSTRAINT FK_PetHealthPhotos_Record FOREIGN KEY (HealthRecordID) REFERENCES dbo.PetHealthRecords(HealthRecordID) ON DELETE CASCADE
);
GO
...
CREATE TABLE dbo.Notifications (
                                   ...
                                   CONSTRAINT FK_Notifications_Appointment FOREIGN KEY (AppointmentID) REFERENCES dbo.Appointments(AppointmentID) ON DELETE SET NULL
);
GO

/* =========================================================
   7B) SERVICE REPORTS & EVIDENCES (UC-29 / UC-31)
   ========================================================= */
CREATE TABLE dbo.ServiceReports (
                                    ...
                                    CONSTRAINT FK_ServiceReports_Appointment FOREIGN KEY (AppointmentID) REFERENCES dbo.Appointments(AppointmentID),
                                    CONSTRAINT FK_ServiceReports_Staff FOREIGN KEY (StaffID) REFERENCES dbo.Staff(StaffID)
);
GO

CREATE TABLE dbo.ServiceEvidences (
                                      EvidenceID INT IDENTITY(1,1) PRIMARY KEY,
                                      ReportID INT NOT NULL,
                                      ImageUrl VARCHAR(500) NOT NULL,
                                      CapturedAt DATETIME2 NOT NULL DEFAULT SYSDATETIME(),
                                      Source VARCHAR(50) NULL,
                                      CONSTRAINT FK_ServiceEvidences_Report FOREIGN KEY (ReportID) REFERENCES dbo.ServiceReports(ReportID) ON DELETE CASCADE
);
GO
...
-- Service reports / evidences
CREATE INDEX IX_ServiceReports_Appointment ON dbo.ServiceReports(AppointmentID);
CREATE INDEX IX_ServiceReports_Staff_SubmittedAt ON dbo.ServiceReports(StaffID, SubmittedAt DESC);
CREATE INDEX IX_ServiceEvidences_Report ON dbo.ServiceEvidences(ReportID);
...
-- Seed Customers (Unicode: dùng N'...' để lưu tiếng Việt có dấu)
INSERT INTO dbo.Customers(Username, PasswordHash, Email, Phone, FullName, IsActive, AuthProvider)
VALUES
    ('customer01', 'e10adc3949ba59abbe56e057f20f883e', 'customer01@petshop.com', '0987654321', N'Phan Tuấn Thành', 1, 'LOCAL'),
    ('customer02', 'e10adc3949ba59abbe56e057f20f883e', 'customer02@petshop.com', '0976543210', N'Nguyễn Thị Ánh', 1, 'LOCAL'),
    ('customer03', 'e10adc3949ba59abbe56e057f20f883e', 'customer03@petshop.com', '0965432109', N'Trần Đăng Khoa', 1, 'LOCAL');
